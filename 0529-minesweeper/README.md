<h2><a href="https://leetcode.com/problems/minesweeper/">529. Minesweeper</a></h2><h3>Medium</h3><hr><div><p>Let's play the minesweeper game (<a href="https://en.wikipedia.org/wiki/Minesweeper_(video_game)" target="_blank" class="docs-creator">Wikipedia</a>, <a href="http://minesweeperonline.com" target="_blank" class="docs-creator">online game</a>)!</p>
